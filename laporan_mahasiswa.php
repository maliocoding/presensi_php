                        ...
                        <div class="tab-content">
                             <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title"></h5>
                                        <form method="post" action="laporan_mahasiswa.php">
                                      ...
                                      <div class="card-body"><h5 class="card-title" align="right"><input type="button" class="btn btn-primary" onclick="printDiv('printableArea')" value="Cetak" /></h5>
                                            ...
                                            <div class="position-relative row form-group">
                                              ...
                                              $qry= mysqli_query($con, "SELECT
                                                                      b.matkul,
                                                                      b.kode,
                                                                      sum( CASE WHEN a.STATUS = 0 OR a.STATUS = 1 THEN 1 ELSE 0 END ) AS jumlah_presensi,
                                                                      sum( CASE WHEN a.STATUS = 2 THEN 1 ELSE 0 END ) AS jumlah_izin,
                                                                      sum( CASE WHEN a.STATUS = 3 THEN 1 ELSE 0 END ) AS jumlah_sakit,
                                                                      sum( CASE WHEN a.STATUS = 1 THEN 1 ELSE 0 END ) AS jumlah_telat 
                                                                    FROM
                                                                      absen a left join matkul b on a.matkul=b.kode
                                                                    WHERE
                                                                      a.ta = '$ta' 
                                                                      AND a.kelas = '$kelas' 
                                                                      AND a.npm = '$mynpm' 
